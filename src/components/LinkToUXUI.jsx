...
const LinkToUXUI = () => {
  return (
    <div className='flex justify-between items-center max-w-[800px] mt-6 mx-auto font-light text-zinc-100 bg-zinc-900 p-4 rounded-sm'>
        ...
        <div>
          <p><span className='font-semibold'>Curious to see my work?</span> Check out my Product Designer portfolio</p>
        </div>
          ...
          <Link 
            ...
            >
            Let's go! 
            <img src='/icons/arrow-right-black.svg' className='group-hover:translate-x-[4px] duration-150'/>
            </Link>
