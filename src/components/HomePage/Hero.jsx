      ...
      <div className='pb-12'>
        ...
        <p className='pb-4'>I'm <span className='font-semibold'>Verónica</span>, a Berlin based <span className='font-semibold'>analog photography enthusiast</span> and 
          <span className='font-semibold'> female solo traveler</span>. Here I've collected snaps from my backpacking adventures over the years 🎒📸✌🏽🗺️.
            ...
            href="/about" 
            target="_self"
            className='group text-xl text-zinc-400 fill-zinc-400 hover:text-zinc-100 underline underline-offset-2 text-nowrap flex items-center gap-2 transition-all w-fit mt-4'
            >
              Read more
