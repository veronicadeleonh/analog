    ...
    <div className={containerSmall}>
      <div className='pb-12'>
        ...
        <Link 
          ...
          >
          Read more
          <svg width="24" height="24" viewBox="0 0 24 24" className='fill-zinc-500 group-hover:fill-zinc-900 group-hover:translate-x-[4px] transition-all duration-150' xmlns="http://www.w3.org/2000/svg">
