  ...
  return (
    <div className='sm:order-first order-last'>
        ...
        <p className='text-zinc-50'>
          ...
          <span onClick={() => handleFilterClick('Year', year.toString())} className='font-mono p-1 bg-orange-200/20 text-orange-100 text-sm rounded-sm cursor-pointer transition-all duration-150 hover:bg-orange-200/30'>{year}</span></p>
    </div>
  )
}
