...
const PrevSlideButton = ({ prevSlide }) => {
  return (
    <div 
        ...
        onClick={prevSlide}
        >
          <svg className="w-8 h-8 fill-zinc-500 transition-all duration-150 hover:fill-zinc-50 hover:translate-x-[-2px] focus:fill-zinc-50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
