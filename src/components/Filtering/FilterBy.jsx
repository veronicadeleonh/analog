...
export const FilterBy = ({filterBySelectionclick, selectedFilterBy}) => {
 ...
 let filterByArr = ['City', 'Country', 'Year']
  ...
  return (
    <div className='flex gap-2 items-center bg-zinc-900 p-2'>
            <div className='uppercase text-zinc-600 text-sm'>Filter by</div>
            <div className='overflow-x-scroll md:overflow-auto whitespace-nowrap flex gap-1 md:flex-wrap md:justify-center items-center font-normal text-l text-zinc-500 rounded-sm'>
