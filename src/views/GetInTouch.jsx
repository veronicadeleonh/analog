  ...
  return (
    ...
    <div className={containerSmall}>
      <div className='font-light text-zinc-100 text-lg'>
            ...
            <a className='mt-4 group flex gap-2 items-center border-2 border-zinc-800 w-fit px-3 py-2 rounded-sm font-medium transition-all duration-150 hover:bg-zinc-200 hover:text-zinc-900 active:bg-zinc-100' href="mailto:hello@veronicadeleon.de">
